...
HD_PWD='W:/ECE532/Server_NN/Server_NN/T5.runs/design_1_axi_ethernet_0_dma_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_ethernet_0_dma_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_ethernet_0_dma_0.tcl
