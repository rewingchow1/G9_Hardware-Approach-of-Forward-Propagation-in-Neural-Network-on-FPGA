...
proc create_hier_cell_s04_nodes { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net m_sc_clk_1 [get_bd_pins m_sc_clk] [get_bd_pins s04_aw_node/m_sc_aclk] [get_bd_pins s04_b_node/s_sc_aclk] [get_bd_pins s04_w_node/m_sc_aclk]
  connect_bd_net -net m_sc_resetn_1 [get_bd_pins m_sc_resetn] [get_bd_pins s04_aw_node/m_sc_aresetn] [get_bd_pins s04_b_node/s_sc_aresetn] [get_bd_pins s04_w_node/m_sc_aresetn]
  connect_bd_net -net s_sc_clk_1 [get_bd_pins s_sc_clk] [get_bd_pins s04_aw_node/s_sc_aclk] [get_bd_pins s04_b_node/m_sc_aclk] [get_bd_pins s04_w_node/s_sc_aclk]
  connect_bd_net -net s_sc_resetn_1 [get_bd_pins s_sc_resetn] [get_bd_pins s04_aw_node/s_sc_aresetn] [get_bd_pins s04_b_node/m_sc_aresetn] [get_bd_pins s04_w_node/s_sc_aresetn]
...
proc create_hier_cell_m00_exit_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.RDATA_WIDTH {32} \
   CONFIG.READ_WRITE_MODE {READ_WRITE} \
   CONFIG.SSC000_ROUTE {0b0000001} \
   CONFIG.SSC001_ROUTE {0b0000010} \
   CONFIG.SSC002_ROUTE {0b0000100} \
   CONFIG.SSC003_ROUTE {0b0001000} \
   CONFIG.SSC004_ROUTE {0b0010000} \
   CONFIG.SSC005_ROUTE {0b0100000} \
   CONFIG.SSC006_ROUTE {0b1000000} \
   CONFIG.SSC007_ROUTE {0b0000000} \
   CONFIG.SSC_ROUTE_WIDTH {7} \
   CONFIG.S_ID_WIDTH {3} \
   CONFIG.WDATA_WIDTH {32} \
 ] $m00_exit
...
proc create_hier_cell_clk_map { parentCell nameHier } {
  ...
  connect_bd_net -net clk_map_aclk_net [get_bd_pins S00_ACLK] [get_bd_pins S01_ACLK] [get_bd_pins S02_ACLK] [get_bd_pins S03_ACLK] [get_bd_pins S04_ACLK] [get_bd_pins S05_ACLK] [get_bd_pins S06_ACLK] [get_bd_pins aclk] [get_bd_pins swbd_aclk] [get_bd_pins psr_aclk/slowest_sync_clk]
  ...
  connect_bd_net -net psr_aclk_interconnect_aresetn [get_bd_pins S00_ARESETN] [get_bd_pins S01_ARESETN] [get_bd_pins S02_ARESETN] [get_bd_pins S03_ARESETN] [get_bd_pins S04_ARESETN] [get_bd_pins S05_ARESETN] [get_bd_pins S06_ARESETN] [get_bd_pins swbd_aresetn] [get_bd_pins psr_aclk/interconnect_aresetn]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {S00_AXI:S01_AXI:S02_AXI:S03_AXI:S04_AXI:S05_AXI:S06_AXI} \
 ] $aclk
  ...
  connect_bd_intf_net -intf_net S_SC_AR_4 [get_bd_intf_pins s03_axi2sc/M_SC_AR] [get_bd_intf_pins s03_nodes/S_SC_AR]
  connect_bd_intf_net -intf_net S_SC_AR_5 [get_bd_intf_pins s05_axi2sc/M_SC_AR] [get_bd_intf_pins s05_nodes/S_SC_AR]
  connect_bd_intf_net -intf_net S_SC_AR_6 [get_bd_intf_pins m00_nodes/S_SC_AR] [get_bd_intf_pins switchboards/M00_SC_AR]
  ...
  connect_bd_intf_net -intf_net S_SC_R_4 [get_bd_intf_pins s03_nodes/S_SC_R] [get_bd_intf_pins switchboards/M03_SC_R]
  connect_bd_intf_net -intf_net S_SC_R_5 [get_bd_intf_pins s05_nodes/S_SC_R] [get_bd_intf_pins switchboards/M05_SC_R]
  connect_bd_intf_net -intf_net S_SC_R_6 [get_bd_intf_pins m00_nodes/S_SC_R] [get_bd_intf_pins m00_sc2axi/M_SC_R]
