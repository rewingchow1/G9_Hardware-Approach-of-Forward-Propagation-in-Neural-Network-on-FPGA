...
proc update_PARAM_VALUE.L1_Neuron_No { PARAM_VALUE.L1_Neuron_No } {
	# Procedure called to update L1_Neuron_No when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.L1_Neuron_No { PARAM_VALUE.L1_Neuron_No } {
	# Procedure called to validate L1_Neuron_No
	return true
}

proc update_PARAM_VALUE.L2_Neuron_No { PARAM_VALUE.L2_Neuron_No } {
	# Procedure called to update L2_Neuron_No when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.L2_Neuron_No { PARAM_VALUE.L2_Neuron_No } {
	# Procedure called to validate L2_Neuron_No
	return true
}

proc update_PARAM_VALUE.L3_Neuron_No { PARAM_VALUE.L3_Neuron_No } {
	# Procedure called to update L3_Neuron_No when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.L3_Neuron_No { PARAM_VALUE.L3_Neuron_No } {
	# Procedure called to validate L3_Neuron_No
	return true
}
...
proc update_MODELPARAM_VALUE.L1_Neuron_No { MODELPARAM_VALUE.L1_Neuron_No PARAM_VALUE.L1_Neuron_No } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.L1_Neuron_No}] ${MODELPARAM_VALUE.L1_Neuron_No}
}

proc update_MODELPARAM_VALUE.L2_Neuron_No { MODELPARAM_VALUE.L2_Neuron_No PARAM_VALUE.L2_Neuron_No } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.L2_Neuron_No}] ${MODELPARAM_VALUE.L2_Neuron_No}
}

proc update_MODELPARAM_VALUE.L3_Neuron_No { MODELPARAM_VALUE.L3_Neuron_No PARAM_VALUE.L3_Neuron_No } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.L3_Neuron_No}] ${MODELPARAM_VALUE.L3_Neuron_No}
}
